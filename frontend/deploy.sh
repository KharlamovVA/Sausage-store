...
sudo rm -f /home/front-user/||true
...
sudo cp ./sausage-store.tar.gz /home/front-user/||true #"<...>||true" говорит, если команда обвалится — продолжай
tar xvzf /home/front-user/sausage-store.tar.gz
