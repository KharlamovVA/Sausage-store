...
curl -u ${NEXUS_REPO_USER}:${NEXUS_REPO_PASS} -o sausage-store.jar ${NEXUS_REPOFRONT_URL}/${VERSION}/sausage-store-${VERSION}.tar.gz
sudo cp ./sausage-store.tar.gz /home/front-user/frontend||true #"<...>||true" говорит, если команда обвалится — продолжай
tar xvzf /home/front-user/frontend/sausage-store-${VERSION}.tar.gz
